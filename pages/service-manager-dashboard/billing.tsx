...
const invoices: Invoice[] = [
  { id: 'INV-801', company: 'A. Adams Plumbing', plan: 'Enterprise', date: '01 Jul', amount: '$499.00', status: 'Paid' },
  { id: 'INV-802', company: 'M. Davis Co.', plan: 'Business', date: '05 Jul', amount: '$199.00', status: 'Pending' },
  { id: 'INV-803', company: 'Quick Fix Ltd.', plan: 'Starter', date: '10 Jul', amount: '$79.00', status: 'Upcoming' },
]
...
const BillingPage: NextPage = () => {
  ...
  return (
    <ServiceManagerShell
      ...
      subtitle="Manage company-level subscription and payments."
      active="Admin"
    >
                  ...
                  {invoices.map((inv) => {
                    ...
                    return (
                      <TableRow key={inv.id} sx={{ '&:hover': { bgcolor: '#33415520' }, transition: 'background 0.15s', cursor: 'pointer' }}>
                        ...
                        <TableCell sx={{ color: '#f8fafc', fontWeight: 600, borderBottom: '1px solid #1e293b' }}>{inv.company}</TableCell>
                        <TableCell sx={{ color: '#94a3b8', borderBottom: '1px solid #1e293b' }}>{inv.plan}</TableCell>
            ...
            <Card sx={{ borderRadius: 3, bgcolor: '#1e293b', border: '1px solid #334155', boxShadow: 'none' }}>
              <CardContent>
                ...
                <Stack spacing={1.5}>
                  ...
                  <Button variant="outlined" sx={{ mt: 1, borderColor: '#334155', color: '#f8fafc', '&:hover': { borderColor: '#1976d2' } }}>
                    Update payment
                  </Button>
                </Stack>
              </CardContent>
                ...
                <Stack spacing={2}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Box>
                      ...
                      <Typography variant="h5" fontWeight={800} color="#f8fafc" sx={{ mt: 0.25 }}>$777</Typography>
                    </Box>
                  ...
                  <Box sx={{ height: 8, borderRadius: 4, bgcolor: '#0f172a', overflow: 'hidden' }}>
                    <Box sx={{ width: '65%', height: '100%', borderRadius: 4, bgcolor: '#1976d2' }} />
                  </Box>
                  <Typography variant="caption" color="#64748b">65% of company budget</Typography>
                </Stack>
              </CardContent>
            </Card>
          </Stack>
